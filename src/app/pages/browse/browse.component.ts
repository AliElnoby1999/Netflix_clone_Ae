...
export class BrowseComponent  implements OnInit {
  constructor(private _Router:Router,private _AuthService:AuthService,private _MoviesService:MoviesService
...
sources=[
  this._MoviesService.getTvShow(),
  this._MoviesService.getMovie(),
  ...
  ngOnInit(): void {
    ...
    this._MoviesService.getMovie().subscribe({
      next: (movies:any) => {
       console.log(movies);
    ...
    this._MoviesService.getTvShow().subscribe({
      next: (movies:any) => {
